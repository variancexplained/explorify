...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /tests/test_stats/test_inferential/test_kruskal.py                                  #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
from explorify.eda.stats.inferential.rank import KruskalWallisHTest
...
@pytest.mark.rank
@pytest.mark.kruskal
class TestKruskalWillisHTest:  # pragma: no cover
    # ============================================================================================ #
    def test_kruskal_willis_test(self, credit, caplog):
        start = datetime.now()
        logger.info(
        ...
        # ---------------------------------------------------------------------------------------- #
        test = KruskalWallisHTest(data=credit, a_name="Education", b_name="Income")
        test.run()
