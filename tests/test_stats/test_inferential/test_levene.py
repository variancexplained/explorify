...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.10                                                                             #
# Filename   : /tests/test_stats/test_inferential/test_levene.py                                   #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
from explorify.eda.stats.inferential.variance import LeveneTest
...
@pytest.mark.levene
class TestLeveneTest:  # pragma: no cover
    # ============================================================================================ #
    def test_levene_test(self, credit, caplog):
        start = datetime.now()
        logger.info(
        ...
        # ---------------------------------------------------------------------------------------- #
        test = LeveneTest(a_name="Education", b_name="Income", data=credit)
        test.run()
